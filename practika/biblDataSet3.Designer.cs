...
namespace practika {
    ...
    public partial class biblDataSet3 : global::System.Data.DataSet {
        ...
        public partial class ЧитателиDataTable : global::System.Data.TypedTableBase<ЧитателиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ЧитателиRow AddЧитателиRow(string Фамилия, string Имя, string Отчество, string Адрес, int Телефон) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ЧитателиRow FindByНомерЧитБилета(int НомерЧитБилета) {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnНомерЧитБилета}, true));
                this.columnНомерЧитБилета.AutoIncrement = true;
                this.columnНомерЧитБилета.AutoIncrementSeed = -1;
                this.columnНомерЧитБилета.AutoIncrementStep = -1;
                this.columnНомерЧитБилета.AllowDBNull = false;
                this.columnНомерЧитБилета.Unique = true;
        ...
        public partial class ЧитателиRow : global::System.Data.DataRow {
            ...
            public int НомерЧитБилета {
                get {
                    return ((int)(this[this.tableЧитатели.НомерЧитБилетаColumn]));
                }
                set {
                    this[this.tableЧитатели.НомерЧитБилетаColumn] = value;
                }
            }
...
namespace practika.biblDataSet3TableAdapters {
    ...
    public partial class ЧитателиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Читатели` WHERE ((`НомерЧитБилета` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Адрес` IS NULL) OR (`Адрес` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Читатели` (`Фамилия`, `Имя`, `Отчество`, `Адрес`, `Телефон`) VALUES " +
                "(?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Читатели` SET `Фамилия` = ?, `Имя` = ?, `Отчество` = ?, `Адрес` = ?, `Телефон` = ? WHERE ((`НомерЧитБилета` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Адрес` IS NULL) OR (`Адрес` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT НомерЧитБилета, Фамилия, Имя, Отчество, Адрес, Телефон FROM Читатели";
        ...
        public virtual int Delete(int Original_НомерЧитБилета, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, global::System.Nullable<int> Original_Телефон) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_НомерЧитБилета));
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, string Адрес, global::System.Nullable<int> Телефон) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Адрес, global::System.Nullable<int> Телефон, int Original_НомерЧитБилета, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, global::System.Nullable<int> Original_Телефон) {
            if ((Фамилия == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_НомерЧитБилета));
            if ((Original_Фамилия == null)) {
